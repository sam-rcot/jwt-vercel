...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
    ...
    const { keyID, issuerID, encryptedAESKey, iv, encryptedPrivateKey }: { keyID?: string; issuerID?: string; encryptedAESKey?: string; iv?: string; encryptedPrivateKey?: string } = req.body;
